...
(when IS-WINDOWS
  ...
  (setenv "PATH" (format "C:/msys64/usr/bin:%s"  (getenv "PATH")))
  ;; bashを指定
...
(use-package denote
  ...
  (general-def :states '(normal visual) :keymaps 'override :prefix "SPC d" :prefix-command 'my-denote-map))
...
(use-package fontaine
  ...
  (cond (IS-LINUX
	 (setq fontaine-presets
	       '((regular
		  :default-family "源ノ角ゴシック Code JP"
		  :default-height 80
		  :fixed-pitch-family "源ノ角ゴシック Code JP"
		  :variable-pitch-family "源ノ角ゴシック VF"
		  :italic-family "源ノ角ゴシック Code JP"
		  :line-spacing 1)
		 (large
		  :default-family "源ノ角ゴシック Code JPゴシック"
		  :default-height 120
		  :variable-pitch-family "源ノ角ゴシック VF"
		  :line-spacing 1))))
	...
	(IS-WINDOWS
	 (setq fontaine-presets
		  ...
		  :variable-pitch-family "ＭＳ Ｐゴシック"
		  :italic-family "Cica"
		  :line-spacing 1)
		 (large
		  :default-family "Cica"
